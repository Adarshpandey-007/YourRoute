...
// Test both AboutUs (mobile) and AboutUsDesktop (desktop)
import AboutDesktop from '../Components/About/AboutUsDesktop'

describe('AboutUs (mobile)', () => {
...
describe('AboutUsDesktop (desktop)', () => {
  test('renders AboutDesktop component with headings and contributors', () => {
    render(
      <BrowserRouter>
        <AboutDesktop />
      </BrowserRouter>,

      ...
      >
        ...
        >
          <Stack direction="column" alignItems="center" spacing={1}>
            ...
            <Typography variant="h6" color="text.primary">
              With YourRoute, you get real-time locations of all loop buses,
        ...
        >
          <Stack direction="column" alignItems="center" spacing={1}>
            ...
            <Typography variant="h6" color="text.primary">
              Beyond Campus Shuttles, YourRoute extends its service by providing
        ...
        >
          <Stack direction="column" alignItems="center" spacing={1}>
            ...
            <Typography variant="h6" color="text.primary">
              You can install YourRoute on your device for even quicker access.
